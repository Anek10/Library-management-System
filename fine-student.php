...
<div class="container">
	...
	<div class="container">
        ...
        <div class="alert alert-success alert-dismissable">
            ...
            <?php } ?>
		  	<div class="row"><form method="get" action="insert2.html">
    
		  	  <a><button class="btn btn-success col-lg-3 col-md-4 col-sm-11 col-xs-11 button" style="margin-left: 15px;margin-bottom: 5px"> Pay Fines</button></a></form
