...
<input type="date" id="myDate" class='form-control' name="borrowDate" min="<?=date('Y-m-d', strtotime('+0 days')) ?>" max="<?=date('Y-m-d', strtotime('+0 days')) ?>">
<script>
function myFunction() {
...
<input type='date' id='myDate' class='form-control' name='dueDate' min="<?=date('Y-m-d', strtotime('+0 days')) ?>" max="<?=date('Y-m-d', strtotime('+5 days')) ?>">
<script>
function myFunction() {
  var x = document.getElementById("myDate").max;
document.getElementById("demo").innerHTML = x;
